...
public class RouletteBase {
   ...
   */
  protected final Map<RouletteBetTypes, Integer> betTypePayoutMap = createBetTypePayoutMap();

  /**
   * A map associating numbers with their corresponding colors on the Roulette wheel.
   */
